    ...
    <ScrollView>
        ...
        <View style={styles.flex_one}>
          <View style={styles.item}>
            <Surface theme={theme} style={{ height: 504 }}>
              <Title style={{ paddingLeft: 15, paddingTop: 5 }} theme={theme}>Your ancestry map</Title>
              <Map />
            </Surface>
          </View>
          <View style={styles.item}>
            <Surface theme={theme} style={{ height: 504 }}>
              <Title style={{ paddingLeft: 15, paddingTop: 5 }} theme={theme}>Genetic diseases risk analysis</Title>
      ...
      <View style={styles.container}>
        <View style={styles.flex}>
          <View style={styles.item}>
            <Surface theme={theme} style={{minHeight: 200}}>
